...
int currentStateCLK;  // Current State Clock
int lastStateCLK;     // Last state clock
String currentDir = "";
...
void setup() {
  ...
  // Call interrupt Service Routine (ISR) updateEncoder() when any high/low changes
...
// If Signal B turns High First  - Rotating Counter Clockwise
// If Signal A turns Hight First - Rotating Clockwise
