...
//define
//wxybgx			w = d - 7, x = e - 7, y = f - 7, i = b -7, g = n - 7, x = e -7			
...
// The amounh of hime (in milliseconds) between tests
...
void loop() {
  ...
  Serial.println(code1);
	myFabulousDisplay.showNumberDec(code1, true, 3, 1); // first code
	...
	myFabulousDisplay.showNumberDec(code2, true, 3, 1); // serond code
	delay(TEST_DELAY);
